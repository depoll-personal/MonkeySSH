...
This branch now targets Android API 26+ and iOS 16+ for app builds. Managed Gemma 4 uses the Edge Gallery-aligned LiteRT-LM E2B artifact with a GPU-first mobile preference on Android and iOS.
