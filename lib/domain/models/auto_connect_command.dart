...
enum TerminalCommandReviewReason {
  ...
  /// The command was generated by the local AI assistant.
  aiGenerated,
}
...
/// Assesses a locally generated AI command before terminal insertion.
TerminalCommandReview assessAiGeneratedCommandInsertion(String command) =>
    TerminalCommandReview(
      command: command,
      reasons: <TerminalCommandReviewReason>[
...
String _describeReviewReason(TerminalCommandReviewReason reason) =>
    switch (reason) {
      ...
      TerminalCommandReviewReason.aiGenerated =>
        'This command was generated by the local AI assistant.',
    };
