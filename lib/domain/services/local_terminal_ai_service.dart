...
const _managedPromptBudget = _LocalTerminalAiPromptBudget(
  maxSuggestionTokens: 2048,
  maxCompletionTokens: 1024,
  maxTaskDescriptionChars: 600,
  maxHostLabelChars: 160,
  maxWindowTitleChars: 200,
  maxWindowIconChars: 100,
  maxConnectionStateChars: 48,
  maxWorkingDirectoryChars: 320,
  maxCurrentTerminalLineChars: 1200,
  maxShellStatusChars: 80,
  maxSelectedTerminalTextChars: 1200,
  maxRecentTerminalContextChars: 4000,
);
const _androidManagedPromptBudget = _LocalTerminalAiPromptBudget(
  ...
  maxConnectionStateChars: 48,
  maxWorkingDirectoryChars: 280,
  maxCurrentTerminalLineChars: 960,
  maxShellStatusChars: 80,
  maxSelectedTerminalTextChars: 1000,
  maxRecentTerminalContextChars: 3200,
);
