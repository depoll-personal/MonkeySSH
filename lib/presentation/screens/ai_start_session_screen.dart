...
class _AiStartSessionScreenState extends ConsumerState<AiStartSessionScreen> {
  ...
  static const _acpAdapterInstallCommand =
      ...
      r'/${FILENAME}"; '
      r'case "${ARCH}-${OS}" in '
      'x86_64-darwin) EXPECTED_SHA=1c03d3d1e396ba0e978c3b8265744537f9600bffa559362277f456f1468a23be ;; '
      'aarch64-darwin) EXPECTED_SHA=78637244a753c9a1efcfd386062920516ebddbe1bf2809aab019aabe754dbb36 ;; '
      'x86_64-linux) EXPECTED_SHA=0ae60e30db2daad2a803c6b38c8d2514a6744b62c1cb1ac4561ba80b33ae6fb7 ;; '
      'aarch64-linux) EXPECTED_SHA=20d235dd70d3e98bcab1a06f51bef3c25c95293cd91d3fcce1ac643810aa02da ;; '
      r'*) echo "Unsupported ACP adapter target: ${ARCH}-${OS}" >&2; exit 1 ;; esac; '
