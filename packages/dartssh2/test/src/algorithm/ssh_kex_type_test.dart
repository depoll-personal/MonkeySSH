...
void main() {
  group('SSHKexType', () {
    test('Static constants are defined correctly', () {
      expect(SSHKexType.mlkem768X25519.name, equals('mlkem768x25519-sha256'));
      expect(SSHKexType.sntrup761X25519.name, equals('sntrup761x25519-sha512'));
      expect(SSHKexType.sntrup761X25519OpenSsh.name,
    ...
    test(
        ...
        () {
      expect(SSHKexType.mlkem768X25519.digestFactory, equals(digestSha256));
      expect(SSHKexType.sntrup761X25519.digestFactory, equals(digestSha512));
      expect(SSHKexType.sntrup761X25519OpenSsh.digestFactory,
          equals(digestSha512));
